...
(setq exwm-input-global-keys
	 ...
	 ([?\s-\;] . windmove-up)
	 ([?\s-\'] . windmove-right)
	 (,(kbd "<XF86Tools>") . other-frame)
	 (,(kbd "<XF86Launch5>") . other-window)
	 (,(kbd "<XF86Launch6>") . split-window-vertically)
	 (,(kbd "<XF86Launch7>") . split-window-horizontally)
	 (,(kbd "<XF86Launch8>") . delete-window)
	 (,(kbd "<XF86Launch9>") . kill-current-buffer)
	 (,(kbd "<XF86Battery>") . previous-buffer)
	 (,(kbd "<redo>") . next-buffer)
