...
(define-key keymux-command-map (kbd "m") 'back-to-indentation)
...
(define-key keymux-command-map (kbd "z") 'zap-up-to-char)
...
(define-key keymux-command-map (kbd "\\ e") 'wymux/eshell)
